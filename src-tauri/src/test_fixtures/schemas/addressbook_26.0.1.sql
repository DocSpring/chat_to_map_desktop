...
-- Source: /Users/ndbroadbent/Library/Application Support/AddressBook/AddressBook-v22.abcddb
...
CREATE TABLE IF NOT EXISTS "Z_18PARENTGROUPS" ( Z_18CHILDGROUPS INTEGER, Z_19PARENTGROUPS INTEGER, PRIMARY KEY (Z_18CHILDGROUPS, Z_19PARENTGROUPS) );
CREATE TABLE IF NOT EXISTS "Z_22PARENTGROUPS" ( Z_22CONTACTS INTEGER, Z_19PARENTGROUPS1 INTEGER, PRIMARY KEY (Z_22CONTACTS, Z_19PARENTGROUPS1) );
...
CREATE INDEX Z_17PARENTGROUPS_Z_18PARENTGROUPS_INDEX ON "Z_18PARENTGROUPS" (Z_19PARENTGROUPS, Z_18CHILDGROUPS);
CREATE INDEX Z_18PARENTGROUPS_Z_19PARENTGROUPS_INDEX ON Z_18PARENTGROUPS (Z_19PARENTGROUPS, Z_18CHILDGROUPS);
CREATE INDEX Z_21PARENTGROUPS_Z_18PARENTGROUPS1_INDEX ON "Z_22PARENTGROUPS" (Z_19PARENTGROUPS1, Z_22CONTACTS);
